...
namespace enter
{
 ...
 public class Form1 : System.Windows.Forms.Form
 {
  ...
  private System.IO.StreamWriter entries_file, links_file, gerunds_file, deeprs_file, infs_file;
     ...
     private TextBox ed_form_noun51;
     ...
     private Button ed_addnoun;
     private TextBox ed_name_noun;
     private TextBox ed_form_noun1;
     private TextBox ed_form_noun2;
     private TextBox ed_form_noun3;
     private TextBox ed_form_noun4;
     private TextBox ed_form_noun5;
     private TextBox ed_form_noun6;
     private TextBox ed_form_noun7;
     private TextBox ed_form_noun8;
     private TextBox ed_form_noun9;
     private TextBox ed_form_noun10;
     private TextBox ed_form_noun11;
     private TextBox ed_form_noun12;
     private Label label14;
     private Label label15;
     private Label label16;
     private ComboBox cbx_gender;
     private ComboBox cbx_anim;
     ...
     private TextBox ed_linknoun1;
     private Label label27;
     private TextBox ed_linknoun2;
     private Label label28;
     private TextBox ed_linknoun3;
     private Label label29;
     private TextBox ed_linknoun4;
     ...
     private TextBox ed_name_adj;
     private Button cb_add_adj;
     private Label label50;
     private Label label51;
     private Label label52;
     private TextBox ed_adjlink4;
     private TextBox ed_adjlink3;
     private TextBox ed_adjlink2;
     private TextBox ed_adjlink1;
     ...
     private TextBox ed_verb1;
     private TextBox ed_verb2;
     private TextBox ed_verb3;
     private TextBox ed_verb4;
     private TextBox ed_verb5;
     private TextBox ed_verb6;
     private TextBox ed_verb9;
     private TextBox ed_verb10;
     private TextBox ed_verb11;
     private TextBox ed_verb12;
     private TextBox ed_verb13;
     ...
     private TextBox ed_verblink1;
     private TextBox ed_verblink2;
     private TextBox ed_verblink5;
     private TextBox ed_verblink6;
     private TextBox ed_verblink4;
     private TextBox ed_verblink3;
     private Button cb_addverb1;
     private CheckBox chb_transitive1;
     private Label label113;
     private TextBox ed_name_verb2;
     private CheckBox chb_transitive2;
     ...
     private Button cb_add_verb2;
     private TextBox ed_pverb1;
     private TextBox ed_pverb3;
     private TextBox ed_pverb5;
     private TextBox ed_pverb2;
     private TextBox ed_pverb4;
     private TextBox ed_pverb6;
     private TextBox ed_pverb7;
     private TextBox ed_pverb8;
     private TextBox ed_pverb9;
     private TextBox ed_pverb10;
     private TextBox ed_pverb11;
     private TextBox ed_pverb12;
     private TextBox ed_pverb13;
     private TextBox ed_pverblink1;
     private TextBox ed_pverblink2;
     private TextBox ed_pverblink3;
     private TextBox ed_pverblink4;
     private TextBox ed_pverblink5;
     private TextBox ed_pverblink6;
     private Label label153;
     private Label label154;
     private Label label155;
     private Label label25;
     private TextBox ed_verblink8;
     private Label label156;
     private Button cb_clear_noun1;
     private Button cb_clear_noun2;
     ...
     private TextBox ed_adj25;
     private TextBox ed_adj21;
     private TextBox ed_adj16;
     private TextBox ed_adj12;
     private TextBox ed_adj8;
     private TextBox ed_adj4;
     private Label label32;
     private Label label74;
     private TextBox ed_adj10_1;
     ...
     private TextBox ed_adj24;
     private TextBox ed_adj23;
     private TextBox ed_adj20;
     private TextBox ed_adj19;
     private TextBox ed_adj15;
     private TextBox ed_adj14;
     private TextBox ed_adj11;
     private TextBox ed_adj10;
     private TextBox ed_adj7;
     private TextBox ed_adj6;
     private TextBox ed_adj3;
     private TextBox ed_adj2;
     ...
     private TextBox ed_adj17;
     private TextBox ed_adj22;
     private TextBox ed_adj18;
     private TextBox ed_adj13;
     private TextBox ed_adj9;
     private TextBox ed_adj5;
     private TextBox ed_adj1;
     ...
     private TextBox ed_adj_sh2;
     private TextBox ed_adj_sh3;
     private TextBox ed_adj_sh4;
     private TabPage tab_adj;
     private TextBox ed_adj_sh1;
     private Label label162;
     private TextBox ed_adj_comp1;
     ...
     private TextBox ed_adj_sup9;
     private TextBox ed_adj_sup5;
     private TextBox ed_adj_sup11;
     private TextBox ed_adj_sup10;
     private TextBox ed_adj_sup7;
     private TextBox ed_adj_sup6;
     private TextBox ed_adj_sup3;
     private TextBox ed_adj_sup2;
     private TextBox ed_adj_sup12;
     private TextBox ed_adj_sup8;
     private TextBox ed_adj_sup4;
     private TextBox ed_adj_sup10_1;
     private TextBox ed_adj_sup17;
     private TextBox ed_adj_sup13;
     private TextBox ed_adj_sup15;
     private TextBox ed_adj_sup14;
     private TextBox ed_adj_sup16;
     private TextBox ed_adj_sup16_2;
     private TextBox ed_adj_sup22;
     private TextBox ed_adj_sup18;
     private TextBox ed_adj_sup24;
     private TextBox ed_adj_sup23;
     private TextBox ed_adj_sup20;
     private TextBox ed_adj_sup19;
     private TextBox ed_adj_sup25;
     private TextBox ed_adj_sup21;
     private Label label201;
     private TextBox ed_adj_comp2;
     ...
     private Button cb_clear_short;
     private Button cb_clear_compar;
     private Label label205;
     private Label label206;
     private Label label207;
     private TextBox ed_verb7;
     private TextBox ed_verb8;
  ...
  private void InitializeComponent()
  {
   ...
   this.tabPage1.Text = "—Û˘ÂÒÚ‚ËÚÂÎ¸ÌÓÂ";
   ...
   this.label26.Text = "‚ ÔËÎ‡„‡ÚÂÎ¸ÌÓÂ";
   // 
   // ed_form_noun51
   // 
   ...
   this.label16.Text = "ÔÂÂ˜ËÒÎËÏÓÒÚ¸:";
   // 
   // label15
   // 
   ...
   this.tabPage3.Text = "ÕÂÒÓ‚Â¯ÂÌÌ˚È √Î‡„ÓÎ";
   ...
   this.chb_transitive1.Text = "ÔÂÂıÓ‰Ì˚È";
   // 
   // label102
   // 
   ...
   this.label80.Text = "ÔÓ¯Â‰¯ÂÂ ‚ÂÏˇ";
   // 
   // label79
   // 
   ...
   this.label79.Text = "Ì‡ÒÚÓˇ˘ÂÂ ‚ÂÏˇ";
   // 
   // cb_addverb1
   // 
   ...
   this.label103.Text = "ÒÛ˘ÂÒÚ‚ËÚÂÎ¸ÌÓÂ";
   // 
   // label78
   // 
   ...
   this.label78.Text = "ÔÓ·Û‰ËÚÂÎ¸ÌÓÂ Ì‡ÍÎÓÌÂÌËÂ";
   // 
   // label77
   // 
   ...
   this.label77.Text = "ËÁ˙ˇ‚ËÚÂÎ¸ÌÓÂ Ì‡ÍÎÓÌÂÌËÂ";
   // 
   // ed_name_verb1
   // 
   ...
   this.label75.Text = "ÕÂÓÔÂ‰ÂÎÂÌÌ‡ˇ ÙÓÏ‡:";
   // 
   // ed_verb7
   // 
   ...
   this.tab_adj.Text = "œËÎ‡„‡ÚÂÎ¸ÌÓÂ";
   ...
   this.tabPage5.Text = "¿ÚË·ÛÚË‚Ì‡ˇ ÙÓÏ‡";
   ...
   this.tabPage7.Text = "—‡‚ÌËÚÂÎ¸Ì‡ˇ ÙÓÏ‡";
   ...
   this.tabPage8.Text = "œÂ‚ÓÒıÓ‰Ì‡ˇ ÙÓÏ‡";
   ...
   this.chb_supreme_add2.Text = "‰Ó·‡‚ËÚ¸ Ú‡ÍÊÂ ÙÓÏ˚ Ò ÔËÒÚ‡‚ÍÓÈ Õ¿»-";
   ...
   this.label39.Text = "ÒÛ˘ÂÒÚ‚ËÚÂÎ¸ÌÓÂ";
   // 
   // ed_name_adj
   // 
   ...
   this.tabPage4.Text = "—Ó‚Â¯ÂÌÌ˚È „Î‡„ÓÎ";
   ...
   this.label143.Text = "ÓÌË ÒÔÓÒËÎË";
   // 
   // label142
   // 
   ...
   this.label142.Text = "ÓÌÓ ÒÔÓÒËÎÓ";
   // 
   // label141
   // 
   ...
   this.label139.Text = "ÓÌË ÒÔÓÒˇÚ";
   // 
   // label138
   // 
   ...
   this.label151.Text = "ÔÓËÌÚÂÂÒÓ‚‡Ú¸Òˇ, ÔÓÎ˛·ÓÔ˚ÚÒÚ‚Ó‚‡Ú¸";
   // 
   // label150
   // 
   ...
   this.label129.Text = "ÒÛ˘ÂÒÚ‚ËÚÂÎ¸ÌÓÂ";
   // 
   // cb_add_verb2
   // 
   ...
   this.label125.Text = "ÔÓ·Û‰ËÚÂÎ¸ÌÓÂ Ì‡ÍÎÓÌÂÌËÂ";
   // 
   // label124
   // 
   ...
   this.label120.Text = "ÔÓ¯Â‰¯ÂÂ ‚ÂÏˇ";
   // 
   // ed_pverb6
   // 
   ...
   this.label114.Text = "ËÁ˙ˇ‚ËÚÂÎ¸ÌÓÂ Ì‡ÍÎÓÌÂÌËÂ";
   // 
   // chb_transitive2
   // 
   ...
   this.chb_transitive2.Text = "ÔÂÂıÓ‰Ì˚È";
   // 
   // ed_name_verb2
   // 
   ...
   this.label113.Text = "ÕÂÓÔÂ‰ÂÎÂÌÌ‡ˇ ÙÓÏ‡:";
   // 
   // tabPage2
   // 
  ...
  private void ed_name_noun_Enter( object sender, System.Windows.Forms.KeyPressEventArgs e )
  {
   if( e.KeyChar == '\r' )
   {
    ...
    if( ed_name_noun.Text.Length > 2 && ed_name_noun.Text[ed_name_noun.Text.Length - 1] == 'ˇ' )
    ...
    if( ed_name_verb1.Text.Length > 2 )
    {
     ...
     if( vf0.Substring( vf0.Length - 2, 2 ) == "Ú¸" )
     {
      string stem = vf0.Substring( 0, vf0.Length - 2 );
      ed_verb7.Text = stem + "Î";
      ed_verb8.Text = stem + "Î‡";
      ed_verb9.Text = stem + "ÎÓ";
      ed_verb10.Text = stem + "ÎË";
     }
     else if( vf0.Length > 4 && vf0.Substring( vf0.Length - 4, 4 ) == "Ú¸Òˇ" )
     {
      string stem = vf0.Substring( 0, vf0.Length - 4 );
      ed_verb7.Text = stem + "ÎÒˇ";
      ed_verb8.Text = stem + "Î‡Ò¸";
      ed_verb9.Text = stem + "ÎÓÒ¸";
      ed_verb10.Text = stem + "ÎËÒ¸";
     }
    }
    ...
    if( vf2.Length > 2 )
    {
     if( vf2.Substring( vf2.Length - 2, 2 ) == "Ú¸" )
     {
      string stem = vf2.Substring( 0, vf2.Length - 2 );
      ed_pverb7.Text = stem + "Î";
      ed_pverb8.Text = stem + "Î‡";
      ed_pverb9.Text = stem + "ÎÓ";
      ed_pverb10.Text = stem + "ÎË";
     }
     else if( vf2.Length > 4 && vf2.Substring( vf2.Length - 4, 4 ) == "Ú¸Òˇ" )
     {
      string stem = vf2.Substring( 0, vf2.Length - 4 );
      ed_pverb7.Text = stem + "ÎÒˇ";
      ed_pverb8.Text = stem + "Î‡Ò¸";
      ed_pverb9.Text = stem + "ÎÓÒ¸";
      ed_pverb10.Text = stem + "ÎËÒ¸";
     }
    }
    ...
    if( sender == ed_name_noun )
    {
     ...
     if( str_dict.Contains( noun ) )
     {
      ...
      {
       // ÓÒÓ·Ó Ó·‡·‡Ú˚‚‡ÂÏ ÒÛ˘ÂÒÚ‚ËÚÂÎ¸Ì˚Â ÊÂÌÒÍÓ„Ó Ó‰‡ Ò ‡Î¸ÚÂÌ‡ÚË‚ÌÓÈ ÙÓÏÓÈ 
       // Ú‚ÓËÚÂÎ¸ÌÓ„Ó Ô‡‰ÂÊ‡ Ì‡ -Œﬁ
       string s8 = forms_list[8];
       string s9 = forms_list[9];
       if( s8[s8.Length - 1] == 'È' && s9[s9.Length - 1] == '˛' )
       {
        ed_form_noun1.Text = TrimForm( forms_list[0] ); // ËÏ
        ed_form_noun2.Text = forms_list[1];
        ed_form_noun3.Text = forms_list[2]; // Ó‰
        ed_form_noun4.Text = forms_list[3];
        ed_form_noun5.Text = forms_list[8]; // Ú‚Ó
        ed_form_noun51.Text = forms_list[8]; // ‡Î¸ÚÂÌ‡ÚË‚Ì‡ˇ ÙÓÏ‡ Ú‚Ó. Ô‡‰ÂÊ‡ "—”ƒ‹¡Œﬁ"
        ed_form_noun6.Text = forms_list[10];

        ed_form_noun7.Text = forms_list[6]; // ‚ËÌ
        ed_form_noun8.Text = forms_list[7];
        ed_form_noun9.Text = forms_list[4]; // ‰‡Ú 
        ed_form_noun10.Text = forms_list[5];
        ed_form_noun11.Text = forms_list[11]; // ÔÂ‰Î
        ed_form_noun12.Text = forms_list[12];
       }
       else
       {
        ed_form_noun1.Text = forms_list[0]; // ËÏ
        ed_form_noun2.Text = forms_list[1];
        ed_form_noun3.Text = forms_list[2]; // Ó‰
        ed_form_noun4.Text = forms_list[3];
        ed_form_noun5.Text = forms_list[8]; // Ú‚Ó
        ...
        ed_form_noun9.Text = forms_list[4]; // ‰‡Ú 
        ed_form_noun10.Text = forms_list[5];
        ed_form_noun11.Text = forms_list[10]; // ÔÂ‰Î
        ed_form_noun12.Text = forms_list[11];
       }
      }
     }
    }
    else if( sender == ed_name_verb1 ) // ÌÂÒÓ‚Â¯ÂÌÌ˚È „Î‡„ÓÎ
    {
     ...
     if( str_dict.Contains( verb ) )
     {
      ...
      if( forms_list.Length >= 15 )
      {
       ...
       ed_verblink4.Text = forms_list[7]; // ‰ÂÂÔË˜‡ÒÚËÂ
       ed_verblink3.Text = forms_list[14]; // ÔË˜‡ÒÚËÂ Ì‡ÒÚ. ‚.

       if( forms_list.Length >= 44 )
        ed_verblink2.Text = forms_list[43]; // ÔË˜‡ÒÚËÂ Ô. ‚.
      }
     }
    }
    else if( sender == ed_name_verb2 ) // ÒÓ‚Â¯ÂÌÌ˚È „Î‡„ÓÎ
    {
     ...
     if( str_dict.Contains( verb ) )
     {
      ...
      if( forms_list.Length >= 15 )
      {
       ...
       int iform = 7;
       if( ( forms_list[iform].EndsWith( "ˇ" )
            || forms_list[iform].EndsWith( "ˇÒ¸" )
            || forms_list[iform].EndsWith( "‡" )
            || forms_list[iform].EndsWith( "‡Ò¸" ) ) &&
            !forms_list[iform].EndsWith( "Òˇ" ) &&
            !forms_list[iform].EndsWith( "ÎÒˇ" ) &&
            !forms_list[iform].EndsWith( "ÍÒˇ" )
          ) iform++;
       ...
       ed_pverblink4.Text = forms_list[7];  // ‰ÂÂÔË˜‡ÒÚËÂ
       ed_pverblink2.Text = forms_list[iform++]; // ÔË˜‡ÒÚËÂ Ô. ‚.
       ed_pverblink3.Text = forms_list[iform++]; // ÒÚ‡‰‡ÚÂÎ¸ÌÓÂ ÔË˜‡ÒÚËÂ Ô. ‚.
      }
     }
    }
    else if( sender == ed_name_adj )
    {
     ...
     if( str_dict.Contains( adj ) )
     {
      ...
      if( forms_list.Length >= 15 )
      {
       ...
       ed_adj13.Text = forms_list[16]; // ‚ËÌ.Ô.
     ...
     else
     {
      ...
      // √ÓÚÓ‚Û˛ Ô‡‡‰Ë„ÏÛ Ì‡ÈÚË ÌÂ Û‰‡ÎÓÒ¸. ¬ ÌÂÍÓÚÓ˚ı ÒÎÛ˜‡ˇı ÏÓÊÌÓ ‰ÓÒÚ‡ÚÓ˜ÌÓ
      // ÛÒÔÂ¯ÌÓ ÓÔÂ‰ÂÎËÚ¸ ÒÍÎÓÌÂÌËÂ ÔÓ ÓÍÓÌ˜‡ÌË˛ ·‡ÁÓ‚ÓÈ ÙÓÏ˚.
      if(
         form0.EndsWith( "˘ËÈ", StringComparison.CurrentCultureIgnoreCase ) ||
         form0.EndsWith( "¯ËÈ", StringComparison.CurrentCultureIgnoreCase ) ||
         form0.EndsWith( "ÊËÈ", StringComparison.CurrentCultureIgnoreCase ) ||
         form0.EndsWith( "˜ËÈ", StringComparison.CurrentCultureIgnoreCase )
        )
      {
       string stem = form0.Substring( 0, ed_name_adj.Text.Length - 2 );

       ed_adj1.Text = form0; // ËÏ.Ô.
       ed_adj2.Text = stem + "‡ˇ";
       ed_adj3.Text = stem + "ÂÂ";
       ed_adj4.Text = stem + "ËÂ";

       ed_adj5.Text = stem + "Â„Ó"; // Ó‰.Ô.
       ed_adj6.Text = stem + "ÂÈ";
       ed_adj7.Text = stem + "Â„Ó";
       ed_adj8.Text = stem + "Ëı";

       ed_adj9.Text = stem + "ËÏ"; // Ú‚Ó.Ô.
       ed_adj10.Text = stem + "ÂÈ";
       ed_adj11.Text = stem + "ËÏ";
       ed_adj12.Text = stem + "ËÏË";
       ed_adj10_1.Text = string.Empty;

       ed_adj13.Text = stem + "Â„Ó"; // ‚ËÌ.Ô.
       ed_adj14.Text = stem + "Û˛";
       ed_adj15.Text = stem + "ÂÂ";
       ed_adj16.Text = stem + "Ëı";

       ed_adj17.Text = stem + "ËÈ";
       ed_adj16_2.Text = stem + "ËÂ";

       ed_adj18.Text = stem + "ÂÏÛ"; // ‰‡Ú.Ô.
       ed_adj19.Text = stem + "ÂÈ";
       ed_adj20.Text = stem + "ÂÏÛ";
       ed_adj21.Text = stem + "ËÏ";

       ed_adj22.Text = stem + "ÂÏ"; // ÔÂ‰Î.Ô.
       ed_adj23.Text = stem + "ÂÈ";
       ed_adj24.Text = stem + "ÂÏ";
       ed_adj25.Text = stem + "Ëı";
      }
      else if(
              form0.EndsWith( "ÓÈ", StringComparison.CurrentCultureIgnoreCase )
             )
      {
       string stem = form0.Substring( 0, ed_name_adj.Text.Length - 2 );
       ...
       ed_adj1.Text = form0; // ËÏ.Ô.
       ed_adj2.Text = stem + "‡ˇ";
       ed_adj3.Text = stem + "ÓÂ";
       ed_adj4.Text = stem + "˚Â";

       ed_adj5.Text = stem + "Ó„Ó"; // Ó‰.Ô.
       ed_adj6.Text = stem + "ÓÈ";
       ed_adj7.Text = stem + "Ó„Ó";
       ed_adj8.Text = stem + "˚ı";

       ed_adj9.Text = stem + "˚Ï"; // Ú‚Ó.Ô.
       ed_adj10.Text = stem + "ÓÈ";
       ed_adj11.Text = stem + "˚Ï";
       ed_adj12.Text = stem + "˚ÏË";
       ed_adj10_1.Text = string.Empty;

       ed_adj13.Text = stem + "Ó„Ó"; // ‚ËÌ.Ô.
       ed_adj14.Text = stem + "Û˛";
       ed_adj15.Text = stem + "ÓÂ";
       ed_adj16.Text = stem + "˚ı";

       ed_adj17.Text = stem + "ÓÈ";
       ed_adj16_2.Text = stem + "˚Â";

       ed_adj18.Text = stem + "ÓÏÛ"; // ‰‡Ú.Ô.
       ed_adj19.Text = stem + "ÓÈ";
       ed_adj20.Text = stem + "ÓÏÛ";
       ed_adj21.Text = stem + "˚Ï";

       ed_adj22.Text = stem + "ÓÏ"; // ÔÂ‰Î.Ô.
       ed_adj23.Text = stem + "ÓÈ";
       ed_adj24.Text = stem + "ÓÏ";
       ed_adj25.Text = stem + "Óı";
      }
      else if(
              form0.EndsWith( "¯ËÈÒˇ", StringComparison.CurrentCultureIgnoreCase ) ||
              form0.EndsWith( "˘ËÈÒˇ", StringComparison.CurrentCultureIgnoreCase )
             )
      {
       ...
       ed_adj1.Text = form0; // ËÏ.Ô.
       ed_adj2.Text = stem + "‡ˇÒˇ";
       ed_adj3.Text = stem + "ÂÂÒˇ";
       ed_adj4.Text = stem + "ËÂÒˇ";

       ed_adj5.Text = stem + "Â„ÓÒˇ"; // Ó‰.Ô.
       ed_adj6.Text = stem + "ÂÈÒˇ";
       ed_adj7.Text = stem + "Â„ÓÒˇ";
       ed_adj8.Text = stem + "ËıÒˇ";

       ed_adj9.Text = stem + "ËÏÒˇ"; // Ú‚Ó.Ô.
       ed_adj10.Text = stem + "ÂÈÒˇ";
       ed_adj11.Text = stem + "ËÏÒˇ";
       ed_adj12.Text = stem + "ËÏËÒˇ";
       ed_adj10_1.Text = string.Empty;

       ed_adj13.Text = stem + "Â„ÓÒˇ"; // ‚ËÌ.Ô.
       ed_adj14.Text = stem + "Û˛Òˇ";
       ed_adj15.Text = stem + "ÂÂÒˇ";
       ed_adj16.Text = stem + "ËıÒˇ";

       ed_adj17.Text = stem + "ËÈÒˇ";
       ed_adj16_2.Text = stem + "ËÂÒˇ";

       ed_adj18.Text = stem + "ÂÏÛÒˇ"; // ‰‡Ú.Ô.
       ed_adj19.Text = stem + "ÂÈÒˇ";
       ed_adj20.Text = stem + "ÂÏÛÒˇ";
       ed_adj21.Text = stem + "ËÏÒˇ";

       ed_adj22.Text = stem + "ÂÏÒˇ"; // ÔÂ‰Î.Ô.
       ed_adj23.Text = stem + "ÂÈÒˇ";
       ed_adj24.Text = stem + "ÂÏÒˇ";
       ed_adj25.Text = stem + "ËıÒˇ";
      }
      else if( form0.EndsWith( "ËÈ", StringComparison.CurrentCultureIgnoreCase ) )
      {
       string stem = form0.Substring( 0, ed_name_adj.Text.Length - 2 );
      ...
      else if( form0.EndsWith( "˚È", StringComparison.CurrentCultureIgnoreCase ) )
      {
       string stem = form0.Substring( 0, ed_name_adj.Text.Length - 2 );
  ...
  private void ed_addnoun_Click( object sender, System.EventArgs e )
  {
   if( cbx_gender.Text == "" )
   {
    MessageBox.Show( "ÌÂÓ·ıÓ‰ËÏÓ Á‡‰‡Ú¸ „‡ÏÏ‡ÚË˜ÂÒÍËÈ Ó‰", "ENTER", MessageBoxButtons.OK, MessageBoxIcon.Error );
    return;
   }

   if( cbx_anim.Text == "" )
   {
    MessageBox.Show( "ÌÂÓ·ıÓ‰ËÏÓ Á‡‰‡Ú¸ Ó‰Û¯Â‚ÎÂÌÌÓÒÚ¸", "ENTER", MessageBoxButtons.OK, MessageBoxIcon.Error );
    return;
   }

   if( cbx_enum.Text == "" )
   {
    MessageBox.Show( "ÌÂÓ·ıÓ‰ËÏÓ Á‡‰‡Ú¸ ÔÂÂ˜ËÒÎËÏÓÒÚ¸", "ENTER", MessageBoxButtons.OK, MessageBoxIcon.Error );
    return;
   }

   AuxData aux = new AuxData( ed_name_noun.Text );

   entries_file.WriteLine( " entry {0} : —”Ÿ≈—“¬»“≈À‹ÕŒ≈\r\n {{", aux.base_form );
   aux.WriteAuxEntry( entries_file );


   entries_file.WriteLine( "  –Œƒ:{0}", cbx_gender.Text );
   entries_file.WriteLine( "  Œƒ”ÿ:{0}", cbx_anim.Text );
   entries_file.WriteLine( "  œ≈–≈◊»—À»ÃŒ—“‹:{0}", cbx_enum.Text );
   ...
   foreach( string s1 in ed_form_noun1.Text.Split( ';' ) )
    if( s1.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:≈ƒ {{ {0} }}", Q( s1 ) );

   foreach( string s2 in ed_form_noun2.Text.Split( ';' ) )
    if( s2.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( s2 ) );

   if( ed_form_noun_vocatif.Text.Length > 0 )
    entries_file.WriteLine( "  œ¿ƒ≈∆:«¬¿“ ◊»—ÀŒ:≈ƒ {{ {0} }}", Q( ed_form_noun_vocatif.Text ) );

   foreach( string s3 in ed_form_noun3.Text.Split( ';' ) )
    if( s3.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:(–Œƒ) ◊»—ÀŒ:≈ƒ {{ {0} }}", Q( s3 ) );

   foreach( string s4 in ed_form_noun4.Text.Split( ';' ) )
    if( s4.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:(–Œƒ) ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( s4 ) );

   if( ed_form_noun_partitif.Text.Length > 0 )
    entries_file.WriteLine( "  œ¿ƒ≈∆:œ¿–“ ◊»—ÀŒ:≈ƒ {{ {0} }}", Q( ed_form_noun_partitif.Text ) );

   foreach( string s5 in ed_form_noun5.Text.Split( ';' ) )
    if( s5.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:≈ƒ {{ {0} }}", Q( s5 ) );

   if( ed_form_noun51.Text != "" && ed_form_noun51.Text != ed_form_noun5.Text )
    entries_file.WriteLine( "  œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:≈ƒ {{ {0} }}", Q( ed_form_noun51.Text ) );

   foreach( string s6 in ed_form_noun6.Text.Split( ';' ) )
    if( s6.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( s6 ) );

   foreach( string s7 in ed_form_noun7.Text.Split( ';' ) )
    if( s7.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:≈ƒ {{ {0} }}", Q( s7 ) );

   foreach( string s8 in ed_form_noun8.Text.Split( ';' ) )
    if( s8.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( s8 ) );

   foreach( string s9 in ed_form_noun9.Text.Split( ';' ) )
    if( s9.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:ƒ¿“ ◊»—ÀŒ:≈ƒ {{ {0} }}", Q( s9 ) );

   foreach( string s10 in ed_form_noun10.Text.Split( ';' ) )
    if( s10.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:ƒ¿“ ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( s10 ) );

   foreach( string s11 in ed_form_noun11.Text.Split( ';' ) )
    if( s11.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:(œ–≈ƒÀ) ◊»—ÀŒ:≈ƒ {{ {0} }}", Q( s11 ) );

   foreach( string s12 in ed_form_noun12.Text.Split( ';' ) )
    if( s12.Trim().Length > 0 )
     entries_file.WriteLine( "  œ¿ƒ≈∆:(œ–≈ƒÀ) ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( s12 ) );

   if( ed_form_noun_locatif.Text.Length > 0 )
    entries_file.WriteLine( "  œ¿ƒ≈∆:Ã≈—“ ◊»—ÀŒ:≈ƒ {{ {0} }}", Q( ed_form_noun_locatif.Text ) );
   ...
   {
    links_file.WriteLine( " extern entry {0} : œ–»À¿√¿“≈À‹ÕŒ≈", ed_linknoun1.Text );
    links_file.WriteLine( " link —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{0}{{}} <‚_ÔËÎ> œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}}", NormalForm( ed_name_noun.Text ), ed_linknoun1.Text );
    links_file.WriteLine( " link œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}} <‚_ÒÛ˘> —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{0}{{}}", NormalForm( ed_name_noun.Text ), ed_linknoun1.Text );
   }

   if( ed_linknoun2.Text != "" )
   {
    links_file.WriteLine( " extern entry {0} : »Õ‘»Õ»“»¬", ed_linknoun2.Text );
    links_file.WriteLine( " link —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{0}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{1}{{}}", NormalForm( ed_name_noun.Text ), ed_linknoun2.Text );
    links_file.WriteLine( " link »Õ‘»Õ»“»¬:{1}{{}} <‚_ÒÛ˘> —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{0}{{}}", NormalForm( ed_name_noun.Text ), ed_linknoun2.Text );
   }

   if( ed_linknoun3.Text != "" )
   {
    links_file.WriteLine( " extern entry {0} : —”Ÿ≈—“¬»“≈À‹ÕŒ≈", ed_linknoun3.Text );
    links_file.WriteLine( " link —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{0}{{}} <synonym> —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{1}{{}}", NormalForm( ed_name_noun.Text ), ed_linknoun3.Text );
    links_file.WriteLine( " link —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{1}{{}} <synonym> —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{0}{{}}", NormalForm( ed_name_noun.Text ), ed_linknoun3.Text );
   }

   if( ed_linknoun4.Text != "" )
   {
    links_file.WriteLine( " link —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{0}{{}} <to_english>  ENG_NOUN:{1}{{}}", NormalForm( ed_name_noun.Text ), ed_linknoun4.Text );
    links_file.WriteLine( " link  ENG_NOUN:{1}{{}} <to_russian> —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{0}{{}}", NormalForm( ed_name_noun.Text ), ed_linknoun4.Text );
   }
  ...
  private void cb_add_adj_Click( object sender, System.EventArgs e )
  {
   ...
   entries_file.WriteLine( " entry {0} : œ–»À¿√¿“≈À‹ÕŒ≈\r\n {{", aux.base_form );

   aux.WriteAuxEntry( entries_file );

   // »Ã≈Õ»“≈À‹Õ€…
   if( ed_adj1.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( ed_adj1.Text ) );

   if( ed_adj2.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( ed_adj2.Text ) );

   if( ed_adj3.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( ed_adj3.Text ) );

   if( ed_adj4.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( ed_adj4.Text ) );


   // –Œƒ»“≈À‹Õ€…
   if( ed_adj5.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(–Œƒ) ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( ed_adj5.Text ) );

   if( ed_adj6.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(–Œƒ) ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( ed_adj6.Text ) );

   if( ed_adj7.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(–Œƒ) ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( ed_adj7.Text ) );

   if( ed_adj8.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(–Œƒ) ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( ed_adj8.Text ) );


   // “¬Œ–»“≈À‹Õ€…
   if( ed_adj9.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( ed_adj9.Text ) );

   if( ed_adj10.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( ed_adj10.Text ) );

   if( ed_adj10_1.Text != "" && ed_adj10_1.Text != ed_adj10.Text )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( ed_adj10_1.Text ) );

   if( ed_adj11.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( ed_adj11.Text ) );

   if( ed_adj12.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( ed_adj12.Text ) );


   // ¬»Õ»“≈À‹Õ€…
   if( ed_adj13.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ Œƒ”ÿ:Œƒ”ÿ {{ {0} }}", Q( ed_adj13.Text ) );

   if( ed_adj17.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ Œƒ”ÿ:Õ≈Œƒ”ÿ {{ {0} }}", Q( ed_adj17.Text ) );

   if( ed_adj14.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( ed_adj14.Text ) );

   if( ed_adj15.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( ed_adj15.Text ) );

   if( ed_adj16.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:ÃÕ Œƒ”ÿ:Œƒ”ÿ  {{ {0} }}", Q( ed_adj16.Text ) );

   if( ed_adj16_2.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:ÃÕ Œƒ”ÿ:Õ≈Œƒ”ÿ  {{ {0} }}", Q( ed_adj16_2.Text ) );


   // ƒ¿“≈À‹Õ€…
   if( ed_adj18.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:ƒ¿“ ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( ed_adj18.Text ) );

   if( ed_adj19.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:ƒ¿“ ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( ed_adj19.Text ) );

   if( ed_adj20.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:ƒ¿“ ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( ed_adj20.Text ) );

   if( ed_adj21.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:ƒ¿“ ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( ed_adj21.Text ) );


   // œ–≈ƒÀŒ∆Õ€…
   if( ed_adj22.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(œ–≈ƒÀ) ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( ed_adj22.Text ) );

   if( ed_adj23.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(œ–≈ƒÀ) ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( ed_adj23.Text ) );

   if( ed_adj24.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(œ–≈ƒÀ) ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( ed_adj24.Text ) );

   if( ed_adj25.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(œ–≈ƒÀ) ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( ed_adj25.Text ) );
   ...
   if( ed_adj_sh1.Text != "" )
   {
    foreach( string f in ed_adj_sh1.Text.Split( ';' ) )
     entries_file.WriteLine( "   –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( f ) );
   }

   if( ed_adj_sh2.Text != "" )
   {
    foreach( string f in ed_adj_sh2.Text.Split( ';' ) )
     entries_file.WriteLine( "   –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( f ) );
   }

   if( ed_adj_sh3.Text != "" )
   {
    foreach( string f in ed_adj_sh3.Text.Split( ';' ) )
     entries_file.WriteLine( "   –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( f ) );
   }

   if( ed_adj_sh4.Text != "" )
   {
    foreach( string f in ed_adj_sh4.Text.Split( ';' ) )
     entries_file.WriteLine( "   –¿“ »… —“≈œ≈Õ‹:¿“–»¡ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( f ) );
   }

   // —–¿¬Õ»“≈À‹Õ¿ﬂ ‘Œ–Ã¿
   if( ed_adj_comp1.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:—–¿¬Õ {{ {0} }}", Q( ed_adj_comp1.Text ) );

   if( ed_adj_comp2.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:—–¿¬Õ {{ {0} }}", Q( ed_adj_comp2.Text ) );

   if( ed_adj_comp3.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:—–¿¬Õ {{ {0} }}", Q( ed_adj_comp3.Text ) );

   if( ed_adj_comp4.Text != "" )
    entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:—–¿¬Õ {{ {0} }}", Q( ed_adj_comp4.Text ) );
   ...
   for( int isup = 0; isup < 2; isup++ )
   {
    ...
    // »Ã≈Õ»“≈À‹Õ€…
    if( ed_adj_sup1.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( prefix, ed_adj_sup1.Text ) );

    if( ed_adj_sup2.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( prefix, ed_adj_sup2.Text ) );

    if( ed_adj_sup3.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( prefix, ed_adj_sup3.Text ) );

    if( ed_adj_sup4.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(»Ã) ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( prefix, ed_adj_sup4.Text ) );


    // –Œƒ»“≈À‹Õ€…
    if( ed_adj_sup5.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(–Œƒ) ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( prefix, ed_adj_sup5.Text ) );

    if( ed_adj_sup6.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(–Œƒ) ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( prefix, ed_adj_sup6.Text ) );

    if( ed_adj_sup7.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(–Œƒ) ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( prefix, ed_adj_sup7.Text ) );

    if( ed_adj_sup8.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(–Œƒ) ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( prefix, ed_adj_sup8.Text ) );


    // “¬Œ–»“≈À‹Õ€…
    if( ed_adj_sup9.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( prefix, ed_adj_sup9.Text ) );

    if( ed_adj_sup10.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( prefix, ed_adj_sup10.Text ) );

    if( ed_adj_sup10_1.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( prefix, ed_adj_sup10_1.Text ) );

    if( ed_adj_sup11.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( prefix, ed_adj_sup11.Text ) );

    if( ed_adj_sup12.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:“¬Œ– ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( prefix, ed_adj_sup12.Text ) );


    // ¬»Õ»“≈À‹Õ€…
    if( ed_adj_sup13.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ Œƒ”ÿ:Œƒ”ÿ {{ {0} }}", Q( prefix, ed_adj_sup13.Text ) );

    if( ed_adj_sup17.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ Œƒ”ÿ:Õ≈Œƒ”ÿ {{ {0} }}", Q( prefix, ed_adj_sup17.Text ) );

    if( ed_adj_sup14.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( prefix, ed_adj_sup14.Text ) );

    if( ed_adj_sup15.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( prefix, ed_adj_sup15.Text ) );

    if( ed_adj_sup16.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:ÃÕ Œƒ”ÿ:Œƒ”ÿ  {{ {0} }}", Q( prefix, ed_adj_sup16.Text ) );

    if( ed_adj_sup16_2.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:¬»Õ ◊»—ÀŒ:ÃÕ Œƒ”ÿ:Õ≈Œƒ”ÿ  {{ {0} }}", Q( prefix, ed_adj_sup16_2.Text ) );


    // ƒ¿“≈À‹Õ€…
    if( ed_adj_sup18.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:ƒ¿“ ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( prefix, ed_adj_sup18.Text ) );

    if( ed_adj_sup19.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:ƒ¿“ ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( prefix, ed_adj_sup19.Text ) );

    if( ed_adj_sup20.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:ƒ¿“ ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( prefix, ed_adj_sup20.Text ) );

    if( ed_adj_sup21.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:ƒ¿“ ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( prefix, ed_adj_sup21.Text ) );


    // œ–≈ƒÀŒ∆Õ€…
    if( ed_adj_sup22.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(œ–≈ƒÀ) ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆ {{ {0} }}", Q( prefix, ed_adj_sup22.Text ) );

    if( ed_adj_sup23.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(œ–≈ƒÀ) ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ {{ {0} }}", Q( prefix, ed_adj_sup23.Text ) );

    if( ed_adj_sup24.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(œ–≈ƒÀ) ◊»—ÀŒ:≈ƒ –Œƒ:—– {{ {0} }}", Q( prefix, ed_adj_sup24.Text ) );

    if( ed_adj_sup25.Text != "" )
     entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:œ–≈¬Œ—’ œ¿ƒ≈∆:(œ–≈ƒÀ) ◊»—ÀŒ:ÃÕ {{ {0} }}", Q( prefix, ed_adj_sup25.Text ) );
    ...
    foreach( string abbrev in ed_adj_abbrev.Text.Split( "\r\n".ToCharArray(), StringSplitOptions.RemoveEmptyEntries ) )
    {
     ...
     if( !string.IsNullOrEmpty( f ) )
      entries_file.WriteLine( "  ~ –¿“ »… —“≈œ≈Õ‹:—Œ –¿Ÿ {{ {0} }}", f );
    }
   ...
   if( ed_adjlink1.Text != "" )
   {
    links_file.WriteLine( " extern entry {0} : —”Ÿ≈—“¬»“≈À‹ÕŒ≈", Q( ed_adjlink1.Text ) );
    links_file.WriteLine( " link œ–»À¿√¿“≈À‹ÕŒ≈:{0}{{}} <‚_ÒÛ˘> —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{1}{{}}", NormalForm( ed_name_adj.Text ), Q( ed_adjlink1.Text ) );
    links_file.WriteLine( " link —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{1}{{}} <‚_ÔËÎ> œ–»À¿√¿“≈À‹ÕŒ≈:{0}{{}}", NormalForm( ed_name_adj.Text ), Q( ed_adjlink1.Text ) );
   }

   if( ed_adjlink2.Text != "" )
   {
    links_file.WriteLine( " extern entry {0} : »Õ‘»Õ»“»¬", Q( ed_adjlink2.Text ) );
    links_file.WriteLine( " link œ–»À¿√¿“≈À‹ÕŒ≈:{0}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{1}{{}}", NormalForm( ed_name_adj.Text ), Q( ed_adjlink2.Text ) );
    links_file.WriteLine( " link »Õ‘»Õ»“»¬:{1}{{}} <‚_ÔËÎ> œ–»À¿√¿“≈À‹ÕŒ≈:{0}{{}}", NormalForm( ed_name_adj.Text ), Q( ed_adjlink2.Text ) );
   }

   if( ed_adjlink3.Text != "" )
   {
    links_file.WriteLine( " extern entry {0} : œ–»À¿√¿“≈À‹ÕŒ≈", ed_adjlink3.Text );
    links_file.WriteLine( " link œ–»À¿√¿“≈À‹ÕŒ≈:{0}{{}} <synonym> œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}}", NormalForm( ed_name_adj.Text ), Q( ed_adjlink3.Text ) );
    links_file.WriteLine( " link œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}} <synonym> œ–»À¿√¿“≈À‹ÕŒ≈:{0}{{}}", NormalForm( ed_name_adj.Text ), Q( ed_adjlink3.Text ) );
   }

   if( ed_adjlink4.Text != "" )
   {
    links_file.WriteLine( " link œ–»À¿√¿“≈À‹ÕŒ≈:{0}{{}} <to_english>  ENG_ADJECTIVE:{1}{{}}", NormalForm( ed_name_adj.Text ), Q( ed_adjlink4.Text ) );
    links_file.WriteLine( " link  ENG_ADJECTIVE:{1}{{}} <to_russian> œ–»À¿√¿“≈À‹ÕŒ≈:{0}{{}}", NormalForm( ed_name_adj.Text ), Q( ed_adjlink4.Text ) );
   }
  ...
  private void cb_addverb1_Click( object sender, System.EventArgs e )
  {
   ...
   entries_file.WriteLine( " extern entry {0} : »Õ‘»Õ»“»¬\r\n", aux.base_form );

   entries_file.WriteLine( " entry {0} : √À¿√ŒÀ\r\n {{", aux.base_form );
   aux.WriteAuxEntry( entries_file );
   entries_file.WriteLine( "  ¬»ƒ : Õ≈—Œ¬≈–ÿ" );

   if( chb_transitive1.Checked )
    entries_file.WriteLine( "  œ≈–≈’ŒƒÕŒ—“‹:œ≈–≈’ŒƒÕ€…" );
   else
    entries_file.WriteLine( "  œ≈–≈’ŒƒÕŒ—“‹:Õ≈œ≈–≈’ŒƒÕ€…" );

   foreach( string ev1 in ed_verb1.Text.Split( ",;".ToCharArray() ) )
   {
    if( ev1.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:Õ¿—“ŒﬂŸ≈≈ À»÷Œ:1 ◊»—ÀŒ:≈ƒ  {{ {0} }}", Q( ev1 ) );
   }

   foreach( string ev2 in ed_verb2.Text.Split( ",;".ToCharArray() ) )
   {
    if( ev2.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:Õ¿—“ŒﬂŸ≈≈ À»÷Œ:1 ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( ev2 ) );
   }

   foreach( string ev3 in ed_verb3.Text.Split( ",;".ToCharArray() ) )
   {
    if( ev3.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:Õ¿—“ŒﬂŸ≈≈ À»÷Œ:2 ◊»—ÀŒ:≈ƒ  {{ {0} }}", Q( ev3 ) );
   }

   foreach( string ev4 in ed_verb4.Text.Split( ",;".ToCharArray() ) )
   {
    if( ev4.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:Õ¿—“ŒﬂŸ≈≈ À»÷Œ:2 ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( ev4 ) );
   }

   foreach( string ev5 in ed_verb5.Text.Split( ",;".ToCharArray() ) )
   {
    if( ev5.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:Õ¿—“ŒﬂŸ≈≈ À»÷Œ:3 ◊»—ÀŒ:≈ƒ  {{ {0} }}", Q( ev5 ) );
   }

   foreach( string ev6 in ed_verb6.Text.Split( ",;".ToCharArray() ) )
   {
    if( ev6.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:Õ¿—“ŒﬂŸ≈≈ À»÷Œ:3 ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( ev6 ) );
   }
   ...
   if( ed_verb7.Text.Length > 0 )
   {
    ...
    {
     if( e7.Length > 0 )
      entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:œ–Œÿ≈ƒÿ≈≈ ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆  {{ {0} }}", Q( e7 ) );
    }
   }
   ...
   if( ed_verb8.Text.Length > 0 )
   {
    ...
    {
     if( e8.Length > 0 )
      entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:œ–Œÿ≈ƒÿ≈≈ ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ  {{ {0} }}", Q( e8 ) );
    }
   }
   ...
   if( ed_verb9.Text.Length > 0 )
   {
    ...
    {
     if( e9.Length > 0 )
      entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:œ–Œÿ≈ƒÿ≈≈ ◊»—ÀŒ:≈ƒ –Œƒ:—–  {{ {0} }}", Q( e9 ) );
    }
   }
   ...
   if( ed_verb10.Text.Length > 0 )
   {
    ...
    {
     if( e10.Length > 0 )
      entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:œ–Œÿ≈ƒÿ≈≈ ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( e10 ) );
    }
   }
   ...
   {
    if( ev11.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:œŒ¡”ƒ À»÷Œ:2 ◊»—ÀŒ:≈ƒ  {{ {0} }}", Q( ev11 ) );
   }

   foreach( string ev12 in ed_verb12.Text.Split( ",;".ToCharArray() ) )
   {
    if( ev12.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:œŒ¡”ƒ À»÷Œ:2 ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( ev12 ) );
   }

   foreach( string ev13 in ed_verb13.Text.Split( ",;".ToCharArray() ) )
   {
    if( ev13.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:œŒ¡”ƒ À»÷Œ:1 ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( ev13 ) );
   }
   ...
   links_file.WriteLine( " link œ–≈ƒ» ¿“:{0}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb1.Text ) );

   if( ed_verblink1.Text != "" )
   {
    links_file.WriteLine( " extern entry {0} : —”Ÿ≈—“¬»“≈À‹ÕŒ≈", NormalForm( ed_verblink1.Text ) );
    links_file.WriteLine( " link »Õ‘»Õ»“»¬:{0}{{}} <‚_ÒÛ˘> —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{1}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( ed_verblink1.Text ) );
    links_file.WriteLine( " link —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{1}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( ed_verblink1.Text ) );
   }

   if( ed_verblink2.Text != "" )
   {
    links_file.WriteLine( " extern entry {0} : œ–»À¿√¿“≈À‹ÕŒ≈", NormalForm( ed_verblink2.Text ) );
    links_file.WriteLine( " link »Õ‘»Õ»“»¬:{0}{{}} <‚_ÔËÎ> œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( ed_verblink2.Text ) );
    links_file.WriteLine( " link œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( ed_verblink2.Text ) );
   }

   if( ed_verblink3.Text != "" )
   {
    links_file.WriteLine( " extern entry {0} : œ–»À¿√¿“≈À‹ÕŒ≈", NormalForm( ed_verblink3.Text ) );
    links_file.WriteLine( " link »Õ‘»Õ»“»¬:{0}{{}} <‚_ÔËÎ> œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( ed_verblink3.Text ) );
    links_file.WriteLine( " link œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( ed_verblink3.Text ) );
   }

   if( ed_verblink4.Text != "" )
   {
    links_file.WriteLine( " link ƒ≈≈œ–»◊¿—“»≈:{1}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( ed_verblink4.Text ) );
   }
   ...
   if( ed_verblink5.Text != "" )
   {
    ...
    {
     links_file.WriteLine( " extern entry {0} : »Õ‘»Õ»“»¬", NormalForm( syn ) );
     links_file.WriteLine( " link »Õ‘»Õ»“»¬:{0}{{}} <synonym> »Õ‘»Õ»“»¬:{1}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( syn ) );
     links_file.WriteLine( " link »Õ‘»Õ»“»¬:{1}{{}} <synonym> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( syn ) );
    }
   }

   if( ed_verblink6.Text != "" )
   {
    links_file.WriteLine( " link »Õ‘»Õ»“»¬:{0}{{}} <to_english> ENG_VERB:{1}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( ed_verblink6.Text ) );
    links_file.WriteLine( " link ENG_VERB:{1}{{}} <to_russian> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb1.Text ), NormalForm( ed_verblink6.Text ) );
   }
   links_file.Flush();

   string inf = NormalForm( ed_name_verb1.Text );
   if( GrammarApi.sol_FindEntry( hEngine, inf, SolarixGrammarEngineNET.GrammarEngineAPI.INFINITIVE_ru, GrammarEngineAPI.RUSSIAN_LANGUAGE ) == -1 )
   {
    infs_file.WriteLine( " entry {0} : »Õ‘»Õ»“»¬ {{ ¬»ƒ:Õ≈—Œ¬≈–ÿ }}", inf );
    infs_file.Flush();
   }

   string deepr = NormalForm( ed_verblink4.Text );
   if( deepr.Length > 0 && GrammarApi.sol_FindEntry( hEngine, deepr, GrammarEngineAPI.GERUND_2_ru, GrammarEngineAPI.RUSSIAN_LANGUAGE ) == -1 )
   {
    deeprs_file.WriteLine( " ‰Ô( {0}, Õ≈—Œ¬≈–ÿ, {1} )", deepr, inf );
    deeprs_file.Flush();
   }
   ...
   for( int i = 0; i < 2; i++ )
   {
    ...
    if( gerund.Length > 0 && GrammarApi.sol_FindEntry( hEngine, gerund, GrammarEngineAPI.ADJ_ru, GrammarEngineAPI.RUSSIAN_LANGUAGE ) == -1 )
    {
     string ending3 = gerund.Substring( gerund.Length - 3 );
     if( ending3 == "ÿ»…" || ending3 == "Ÿ»…" )
     {
      gerunds_file.WriteLine( "  Adj_5034( {0} )", gerund );
      gerunds_file.WriteLine( "  ÔË˜( {0}, {1} )\n", gerund, inf );
      gerunds_file.Flush();
     }

     string ending5 = gerund.Substring( gerund.Length - 5 );
     if( ending5 == "ÿ»…—ﬂ" || ending5 == "Ÿ»…—ﬂ" )
     {
   ...
   if( gerund2.Length > 0 && GrammarApi.sol_FindEntry( hEngine, gerund2, GrammarEngineAPI.ADJ_ru, GrammarEngineAPI.RUSSIAN_LANGUAGE ) == -1 )
   {
    string ending2 = gerund2.Substring( gerund2.Length - 2 );
    if( ending2 == "€…" )
    {
     gerunds_file.WriteLine( "  Adj( {0}, 5031 )", gerund2 );
     gerunds_file.WriteLine( "  ÔË˜( {0}, {1} )", gerund2, inf );
     gerunds_file.WriteLine( "  ÒÚ‡‰( {0} )\n", gerund2 );
     gerunds_file.Flush();
    }
   }
  ...
  private void cb_add_verb2_Click( object sender, System.EventArgs e )
  {
   ...
   {
    if( ep1.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:¡”ƒ”Ÿ≈≈ À»÷Œ:1 ◊»—ÀŒ:≈ƒ  {{ {0} }}", Q( ep1 ) );
   }

   foreach( string ep2 in ed_pverb2.Text.Split( ",;".ToCharArray() ) )
   {
    if( ep2.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:¡”ƒ”Ÿ≈≈ À»÷Œ:1 ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( ep2 ) );
   }

   foreach( string ep3 in ed_pverb3.Text.Split( ",;".ToCharArray() ) )
   {
    if( ep3.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:¡”ƒ”Ÿ≈≈ À»÷Œ:2 ◊»—ÀŒ:≈ƒ  {{ {0} }}", Q( ep3 ) );
   }

   foreach( string ep4 in ed_pverb4.Text.Split( ",;".ToCharArray() ) )
   {
    if( ep4.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:¡”ƒ”Ÿ≈≈ À»÷Œ:2 ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( ep4 ) );
   }

   foreach( string ep5 in ed_pverb5.Text.Split( ",;".ToCharArray() ) )
   {
    if( ep5.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:¡”ƒ”Ÿ≈≈ À»÷Œ:3 ◊»—ÀŒ:≈ƒ  {{ {0} }}", Q( ep5 ) );
   }

   foreach( string ep6 in ed_pverb6.Text.Split( ",;".ToCharArray() ) )
   {
    if( ep6.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:¡”ƒ”Ÿ≈≈ À»÷Œ:3 ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( ep6 ) );
   }
   ...
   if( ed_pverb7.Text.Length > 0 )
   {
    ...
    {
     if( f7.Length > 0 )
      entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:œ–Œÿ≈ƒÿ≈≈ ◊»—ÀŒ:≈ƒ –Œƒ:Ã”∆  {{ {0} }}", Q( f7 ) );
    }
   }
   ...
   if( ed_pverb8.Text.Length > 0 )
   {
    ...
    {
     if( f8.Length > 0 )
      entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:œ–Œÿ≈ƒÿ≈≈ ◊»—ÀŒ:≈ƒ –Œƒ:∆≈Õ  {{ {0} }}", Q( f8 ) );
    }
   }
   ...
   if( ed_pverb9.Text.Length > 0 )
   {
    ...
    {
     if( f9.Length > 0 )
      entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:œ–Œÿ≈ƒÿ≈≈ ◊»—ÀŒ:≈ƒ –Œƒ:—–  {{ {0} }}", Q( f9 ) );
    }
   }
   ...
   if( ed_pverb10.Text.Length > 0 )
   {
    ...
    {
     if( f10.Length > 0 )
      entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:»«⁄ﬂ¬ ¬–≈Ãﬂ:œ–Œÿ≈ƒÿ≈≈ ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( f10 ) );
    }
   }
   ...
   {
    if( ep11.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:œŒ¡”ƒ À»÷Œ:2 ◊»—ÀŒ:≈ƒ  {{ {0} }}", Q( ep11 ) );
   }

   foreach( string ep12 in ed_pverb12.Text.Split( ",;".ToCharArray() ) )
   {
    if( ep12.Length > 0 )
     entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:œŒ¡”ƒ À»÷Œ:2 ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( ep12 ) );
   }

   foreach( string ep13 in ed_pverb13.Text.Split( ",;".ToCharArray() ) )
   {
    if( ep13.Length > 0 ) entries_file.WriteLine( "  Õ¿ ÀŒÕ≈Õ»≈:œŒ¡”ƒ À»÷Œ:1 ◊»—ÀŒ:ÃÕ  {{ {0} }}", Q( ep13 ) );
   }
   ...
   links_file.WriteLine( "" );
   links_file.WriteLine( " link œ–≈ƒ» ¿“:{0}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb2.Text ) );

   if( ed_pverblink1.Text.Length > 0 )
   {
    links_file.WriteLine( " extern entry {0} : —”Ÿ≈—“¬»“≈À‹ÕŒ≈", NormalForm( ed_pverblink1.Text ) );
    links_file.WriteLine( " link »Õ‘»Õ»“»¬:{0}{{}} <‚_ÒÛ˘> —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{1}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( ed_pverblink1.Text ) );
    links_file.WriteLine( " link —”Ÿ≈—“¬»“≈À‹ÕŒ≈:{1}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( ed_pverblink1.Text ) );
   }

   if( ed_pverblink2.Text.Length > 0 )
   {
    links_file.WriteLine( " extern entry {0} : œ–»À¿√¿“≈À‹ÕŒ≈", NormalForm( ed_pverblink2.Text ) );
    links_file.WriteLine( " link »Õ‘»Õ»“»¬:{0}{{}} <‚_ÔËÎ> œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( ed_pverblink2.Text ) );
    links_file.WriteLine( " link œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( ed_pverblink2.Text ) );
   }

   if( ed_pverblink3.Text.Length > 0 )
   {
    links_file.WriteLine( " extern entry {0} : œ–»À¿√¿“≈À‹ÕŒ≈", NormalForm( ed_pverblink3.Text ) );
    links_file.WriteLine( " link »Õ‘»Õ»“»¬:{0}{{}} <‚_ÔËÎ> œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( ed_pverblink3.Text ) );
    links_file.WriteLine( " link œ–»À¿√¿“≈À‹ÕŒ≈:{1}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( ed_pverblink3.Text ) );
   }

   if( ed_pverblink4.Text.Length > 0 )
   {
    links_file.WriteLine( " link ƒ≈≈œ–»◊¿—“»≈:{1}{{}} <‚_ËÌÙËÌËÚË‚> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( ed_pverblink4.Text ) );
   }
   ...
   if( ed_verblink5.Text.Length > 0 )
   {
    ...
    {
     links_file.WriteLine( " extern entry {0} : »Õ‘»Õ»“»¬", NormalForm( syn ) );
     links_file.WriteLine( " link »Õ‘»Õ»“»¬:{0}{{}} <synonym> »Õ‘»Õ»“»¬:{1}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( syn ) );
     links_file.WriteLine( " link »Õ‘»Õ»“»¬:{1}{{}} <synonym> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( syn ) );
    }
   }

   if( ed_pverblink6.Text.Length > 0 )
   {
    links_file.WriteLine( " link »Õ‘»Õ»“»¬:{0}{{}} <to_english> ENG_VERB:{1}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( ed_pverblink6.Text ) );
    links_file.WriteLine( " link ENG_VERB:{1}{{}} <to_russian> »Õ‘»Õ»“»¬:{0}{{}}", NormalForm( ed_name_verb2.Text ), NormalForm( ed_pverblink6.Text ) );
   }
   links_file.Flush();


   string inf = NormalForm( ed_name_verb2.Text );
   if( GrammarApi.sol_FindEntry( hEngine, inf, GrammarEngineAPI.INFINITIVE_ru, GrammarEngineAPI.RUSSIAN_LANGUAGE ) == -1 )
   {
    infs_file.WriteLine( " entry {0} : »Õ‘»Õ»“»¬ {{ ¬»ƒ:—Œ¬≈–ÿ }}", inf );
    infs_file.Flush();
   }
   ...
   if( deepr.Length > 0 && GrammarApi.sol_FindEntry( hEngine, deepr, GrammarEngineAPI.GERUND_2_ru, GrammarEngineAPI.RUSSIAN_LANGUAGE ) == -1 )
   {
    deeprs_file.WriteLine( " ‰Ô( {0}, —Œ¬≈–ÿ, {1} )", deepr, inf );
    deeprs_file.Flush();
   }
  ...
  private void Form1_Load( object sender, System.EventArgs e )
  {
   ...
   var eng = new GrammarEngine();

   if( System.IO.File.Exists(@"C:\Projects\GrammarEngine\src\bin-windows64\dictionary.xml") )
    hEngine = GrammarApi.sol_CreateGrammarEngineW(@"C:\Projects\GrammarEngine\src\bin-windows64\dictionary.xml");
   else if( System.IO.File.Exists( "..\\bin-windows" + platf + "\\dictionary.xml" ) )
    hEngine = GrammarApi.sol_CreateGrammarEngineW( "..\\bin-windows" + platf + "\\dictionary.xml" );
   else if( System.IO.File.Exists( "dictionary.xml" ) )
    hEngine = GrammarApi.sol_CreateGrammarEngineW( "dictionary.xml" );
  ...
  {
   //   if( cbx_enum.SelectedValue.ToString()=="Õ≈“" )
  ...
  private void button1_Click( object sender, EventArgs e )
  {
   ...
   {
    MessageBox.Show( "ÕÂÓ·ıÓ‰ËÏÓ Á‡‰‡Ú¸ Ì‡˜‡Î¸ÌÛ˛ ÙÓÏÛ ËÏ. Ô‡‰ÂÊ‡ Â‰. ˜ËÒÎ‡ ÏÛÊ. Ó‰‡", "Editor",
   ...
   ed_adj_sup2.Text = stem + "‡ˇ";
   ed_adj_sup3.Text = stem + "ÂÂ";
   ed_adj_sup4.Text = stem + "ËÂ";

   ed_adj_sup5.Text = stem + "Â„Ó"; // Ó‰.Ô.
   ed_adj_sup6.Text = stem + "ÂÈ";
   ed_adj_sup7.Text = stem + "Â„Ó";
   ed_adj_sup8.Text = stem + "Ëı";

   ed_adj_sup9.Text = stem + "ËÏ"; // Ú‚Ó.Ô.
   ed_adj_sup10.Text = stem + "ÂÈ";
   ed_adj_sup11.Text = stem + "ËÏ";
   ed_adj_sup12.Text = stem + "ËÏË";
   ed_adj_sup10_1.Text = string.Empty;

   ed_adj_sup13.Text = stem + "Â„Ó"; // ‚ËÌ.Ô.
   ed_adj_sup14.Text = stem + "Û˛";
   ed_adj_sup15.Text = stem + "ÂÂ";
   ed_adj_sup16.Text = stem + "Ëı";

   ed_adj_sup17.Text = stem + "ËÈ";
   ed_adj_sup16_2.Text = stem + "ËÂ";

   ed_adj_sup18.Text = stem + "ÂÏÛ"; // ‰‡Ú.Ô.
   ed_adj_sup19.Text = stem + "ÂÈ";
   ed_adj_sup20.Text = stem + "ÂÏÛ";
   ed_adj_sup21.Text = stem + "ËÏ";

   ed_adj_sup22.Text = stem + "ÂÏ"; // ÔÂ‰Î.Ô.
   ed_adj_sup23.Text = stem + "ÂÈ";
   ed_adj_sup24.Text = stem + "ÂÏ";
   ed_adj_sup25.Text = stem + "Ëı";
