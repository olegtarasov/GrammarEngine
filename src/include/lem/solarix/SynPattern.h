...
namespace Solarix
{
    ...
    struct SynPatternResultBackTrace
    {
        ...
        SynPatternResultBackTrace() : parent(nullptr), result(nullptr) {}
    ...
    struct PatternMarkName
    {
        ...
        PatternMarkName() : pattern_seq(UNKNOWN), syntactical(false) {}

        const lem::UCString& GetName() const { return mark_name; }
        bool empty() const { return mark_name.empty(); }
        void clear() { mark_name.clear(); pattern_seq = UNKNOWN; }
        void SyntacticalMarker() { syntactical = true; }
        bool IsSyntacticalMarker() const { return syntactical; }
    };
    ...
    public:
        ...
        virtual bool ContainsCoordPair(const Solarix::GramCoordPair & pair) const override;
        virtual void GetCoordStates(int coord_id, lem::MCollect<int> & state_ids) const override {}
        virtual void GetCoordStates(const lem::UCString & mark_name, int coord_id, lem::MCollect<int> & state_ids) const override {}
        virtual void SubtractMarkedNodeCoordStates(const lem::UCString & mark_name, int coord_id, lem::MCollect<int> & state_ids) const override {}
    };
    ...
    public:
        ...
        virtual bool ContainsCoordPair(const Solarix::GramCoordPair & pair) const override { return false; }
        virtual void GetCoordStates(int coord_id, lem::MCollect<int> & state_ids) const override {}
        virtual void GetCoordStates(const lem::UCString & mark_name, int coord_id, lem::MCollect<int> & state_ids) const override {}
        virtual void SubtractMarkedNodeCoordStates(const lem::UCString & mark_name, int coord_id, lem::MCollect<int> & state_ids) const override {}
    };
...
#if defined SOL_CAA
        virtual void Run(SynPatternResult & dest, const PatternExportFuncContext & context) const override;
#endif

        virtual int GetExportCoord() const override { return pair.GetCoord().GetIndex(); }
        virtual bool IsAdder() const override { return true; }
    };
    ...
    public:
        ...
        virtual int GetExportCoord() const override { return export_pair.GetCoord().GetIndex(); }
    };
    ...
    public:
        ...
        virtual int GetExportCoord() const override { return export_coord_id; }
    };
    ...
    public:
        ...
        void operator=(const PatternExportSection &) = delete;
    ...
    public:
        ...
        void Terminator() { terminator = true; }

        const lem::UCString& GetMarkerName() const { return mark_name.GetName(); }
    ...
    public:
        ...
        bool HasNamedPatterns() const { return !options.empty(); }
