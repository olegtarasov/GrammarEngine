namespace $rootnamespace$.Properties
{
    public static class ResourceNamesWindows
    {
        ...
        public const string BoostDateTime = "boost_date_time-vc141-mt-x64-1_69.dll";
        public const string BoostRegex = "boost_regex-vc141-mt-x64-1_69.dll";
        //public const string BoostSystem = "boost_system-vc141-mt-x64-1_69.dll";
